...
var WRAPPER_SELECTOR = ".slider__wrapper,.slider2__wrapper",
    ITEMS_SELECTOR = ".slider__items,.slider2__items",
    ITEM_SELECTOR = ".slider__item,.slider2__item",
    CONTROL_CLASS = "slider__control,slider2__control",
    SELECTOR_PREV = '.slider__control[data-slide="prev"],.slider2__control[data-slide="prev"]',
    SELECTOR_NEXT = '.slider__control[data-slide="next"],.slider2__control[data-slide="next"]',
    SELECTOR_INDICATOR = ".slider__indicators>li,.slider2__indicators>li",
    SLIDER_TRANSITION_OFF = "slider_disable-transition,slider2_disable-transition",
    CLASS_CONTROL_HIDE = "slider__control_hide,slider2__control_hide",
    CLASS_ITEM_ACTIVE = "slider__item_active,slider2__item_active",
